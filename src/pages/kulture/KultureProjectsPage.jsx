...
export default function KultureProjectsPage() {
  return (
    <>
      <Helmet>
        <title>Projects - Kustom Koats</title>
        <meta name="description" content="Featured builds and custom projects" />
      </Helmet>
        ...
        <section className="relative py-20 px-6 lg:px-12 xl:px-20" style={{ background: "#000000" }}>
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-lg max-w-2xl" style={{ color: "#CCCCCC", fontFamily: "'Inter', sans-serif" }}>
              Featured builds and custom projects
            </p>
          </div>
        </section>
