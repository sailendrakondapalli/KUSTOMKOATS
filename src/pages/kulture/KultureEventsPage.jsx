...
export default function KultureEventsPage() {
  return (
    <>
      <Helmet>
        <title>Events - Kustom Koats</title>
        <meta name="description" content="Upcoming car shows and automotive events" />
      </Helmet>
        ...
        <section className="relative py-20 px-6 lg:px-12 xl:px-20" style={{ background: "#000000" }}>
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-lg max-w-2xl" style={{ color: "#CCCCCC", fontFamily: "'Inter', sans-serif" }}>
              Upcoming car shows and automotive events
            </p>
          </div>
        </section>
